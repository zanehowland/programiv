...
@interface programivObject : KrollCoverageObject {
#else
@interface programivObject : KrollObject {
#endif
@private
...
extern NSString * programiv$ModuleRequireFormat;
