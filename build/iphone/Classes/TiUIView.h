...
/**
 Base class for all programiv views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the programiv view hierarchy (such as wrapped iOS UIViews) was touched.
