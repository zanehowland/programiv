...
//@interface programivObject : NSObject
//@end

@interface programivObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[programivObject class]])
		{
			for (NSString *key in [[(programivObject*)o modules] allKeys])
			{
