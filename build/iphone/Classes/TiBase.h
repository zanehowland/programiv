...
// in simulator we redefine to format for programiv Developer console
...
{\
	NSString * exceptionName = [@"org.programiv." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.programiv";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIprogramivNativeItemNone = -1, 
	UIprogramivNativeItemSpinner = -2,
	UIprogramivNativeItemProgressBar = -3,
	
	UIprogramivNativeItemSlider = -4,
	UIprogramivNativeItemSwitch = -5,
	UIprogramivNativeItemMultiButton = -6,
	UIprogramivNativeItemSegmented = -7,
	
	UIprogramivNativeItemTextView = -8,
	UIprogramivNativeItemTextField = -9,
	UIprogramivNativeItemSearchBar = -10,
	
	UIprogramivNativeItemPicker = -11,
	UIprogramivNativeItemDatePicker = -12,
	
	UIprogramivNativeItemInfoLight = -13,
	UIprogramivNativeItemInfoDark = -14,
	
	UIprogramivNativeItemDisclosure = -15,
	
	UIprogramivNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all programiv instances of
